    ...
    <group {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]} scale={0.59}>
        <group rotation={[Math.PI / 2, 0, 0]}>
          <group
            position={[-1.49, 55.77, 60.12]}
            rotation={[-Math.PI / 2, 0, Math.PI / 2]}
            scale={0.63}
          >
            <instances.ObjectDefault1 position={[77, 0.43, -88.68]} />
          </group>
          <instances.ObjectDefault
            position={[-1.76, 0, 11.7]}
            rotation={[-Math.PI / 2, 0, Math.PI / 2]}
            scale={0.63}
          />
          <instances.ObjectDefaultghj
            position={[-1.76, 0, 11.7]}
            rotation={[-Math.PI / 2, 0, Math.PI / 2]}
            scale={0.63}
          />
          <instances.ObjectDefault2
            position={[-1.76, 0, 11.7]}
            rotation={[-Math.PI / 2, 0, Math.PI / 2]}
            scale={0.63}
          />
          <instances.ObjectDefault3
            position={[-1.76, 0, 11.7]}
            rotation={[-Math.PI / 2, 0, Math.PI / 2]}
            scale={0.63}
          />
